...
@section('content')
    ...
    <header>
        <h2>@if(isset($purchase))<i class="far fa-edit"></i> Editar Compra @else <i class="fas fa-book-medical"></i> Nova Compra @endif </h2>
    </header>
                ...
                <div class="col">
                  ...
                  <div class="col">
                    <label for="status">Status</label>
                      <input type="text" class="form-control" id="status" name="status" value="{{$purchase->status ?? ''}}" required>
                  </div>
            </div>
